...
const GamePageM = ({ navigation }) => {
  ...
  const loadRandomWord = () => {
    ...
    let availableWords = wordsMedium.words.filter(
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <TouchableOpacity
                ...
                style={styles.modalButton}
              >
                <Text style={styles.modalButtonText}>Sonraki Seviye</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
